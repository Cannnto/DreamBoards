...
// Alterado H -> H_U
!function(t, e) {
    "object" == typeof exports && "object" == typeof module ? (t._H_U = e(),
    module.exports = t._H_U) : "function" == typeof define && define.amd ? define("H_L/H_L", [], e) : "object" == typeof exports ? (t._H_U = e(),
    exports.H_L = t._H_U) : (t.H_U && t.H_U.error(16, !0),
    t.H_U = e())
    ...
    function C(t, e, i, s) {
        let o = e ? "H_U error" : "H_U warning";
        32 === t && (t = `${o}: Deprecated member`);
        let r = D(t)
          , a = r ? `${o} #${t}: www.H_L.com/errors/${t}/` : t.toString();
        if (void 0 !== s) {
            let t = "";
            r && (a += "?"),
            j(s, function(e, i) {
 ...
 - ${i}: ${e}`,
    ...
    let V = {
      ...
      , ty = {
        ...
        lang: {
            ...
            pieSliceName: "Slice",
            resetZoom: "Resetar Zoom", //Alterado
            yAxisTitle: "Values",
    ...
    let tU = {
      ...
      , {trustedTypes: t2} = tV
      , t3 = t2 && tJ(t2.createPolicy) && t2.createPolicy("H_L", {
        createHTML: t => t
    })
      , t5 = t3 ? t3.createHTML("") : "";
    class t6 {
    ...
    class eK {
                ...
                if (g || h.forExport) {
                    try {
                        o = this.fakeTS && function(t) {
                            let e = n.querySelector(".H_L-text-outline");
                            e && eI(e, {
                                display: t
                            })
                        }
        ...
        removeTextOutline() {
            let t = this.element.querySelector("tspan.H_L-text-outline");
    ...
    class e9 extends eJ {
        constructor(t, e, i, s, o, r, a, n, h, l) {
            ...
            this.baseline = h,
            this.className = l,
            this.addClass("button" === l ? "H_L-no-tooltip" : "H_L-label"),
            l && this.addClass("H_L-" + l),
        ...
        updateBoxSize() {
            ...
            this.needsBox && !e.textPath) {
                if (!this.box) {
                    ...
                    t.addClass(("button" === this.className ? "" : "H_L-label-box") + (this.className ? " H_L-" + this.className + "-box" : "")),
                    t.add(this)
                }
      ...
      , im = class {
        ...
        modifyDOM() {
            ...
            for (e.firstLineMetrics = void 0; t = e.element.firstChild; )
                if (/^[\s\u200B]*$/.test(t.textContent || " "))
                    ...
                    break;
            [].forEach.call(e.element.querySelectorAll("tspan.H_L-br"), (t, s) => {
            ...
            let o = (t, o) => {
              ...
              , r = t => {
                [].slice.call(t.childNodes).forEach(i => {
                    i.nodeType === ia.Node.TEXT_NODE ? o(i, t) : (-1 !== i.className.baseVal.indexOf("H_L-br") && (e.actualWidth = 0),
                    r(i))
                }
                )
            }
        ...
        modifyTree(t) {
            let e = (i, s) => {
                ...
                if ("b" === n || "strong" === n ? h ? o.class = "H_L-strong" : a.fontWeight = "bold" : ("i" === n || "em" === n) && (h ? o.class = "H_L-emphasized" : a.fontStyle = "italic"),
                a?.color && (a.fill = a.color),
                "br" === n) {
                    o.class = "H_L-br",
                    i.textContent = "​";
    ...
    class iU {
        constructor(t, e, i, s, o, r, a) {
            ...
            //this.createElement("desc").add().element.appendChild(iv.createTextNode("Created with H_U 12.3.0")), Alterado
        ...
        shadowDefinition(t) {
            let e = [`H_L-drop-shadow-${this.chartIndex}`, ...Object.keys(t).map(e => `${e}-${t[e]}`)].join("-").toLowerCase().replace(/[^a-z\d\-]/g, "")
              , i = iF({
                color: "#000000",
                offsetX: 1,
                offsetY: 1,
        ...
        button(t, e, i, s, o={}, r, a, n, h, l) {
            ...
            d.setState = (t=0) => {
                if (1 !== t && (d.state = g = t),
                d.removeClass(/H_L-button-(normal|hover|pressed|disabled)/).addClass("H_L-button-" + ["normal", "hover", "pressed", "disabled"][t]),
                !c) {
                    d.attr(m[t]);
                    let e = x[t];
                    iW(e) && d.css(e)
    ...
    let si = a
      ...
      , sf = class {
        ...
        renderGridLine(t, e) {
            ...
            a || (o.zIndex = 1),
            t && (e = 0),
            this.gridLine = l = h.path().attr(o).addClass("H_L-" + (a ? a + "-" : "") + "grid-line").add(i.gridGroup)),
        ...
        renderMark(t, e) {
            ...
            !c && (this.mark = c = o.path().addClass("H_L-" + (r ? r + "-" : "") + "tick").add(i.axisGroup),
    ...
    class s$ {
        ...
        createGroups() {
            let {axisParent: t, chart: e, coll: i, options: s} = this
              ...
              , r = (e, r, a) => o.g(e).attr({
                zIndex: a
            }).addClass(`H_L-${i.toLowerCase()}${r} ` + (this.isRadial ? `H_L-radial-axis${r} ` : "") + (s.className || "")).add(t);
        ...
        renderLine() {
            !this.axisLine && (this.axisLine = this.chart.renderer.path().addClass("H_L-axis-line").add(this.axisGroup),
        ...
        drawCrosshair(t, e) {
            ...
            i && !1 !== (sC(e) || !s)) {
                ...
                h || (this.cross = h = o.renderer.path().addClass("H_L-crosshair H_L-crosshair-" + (n ? "category " : "thin ") + (i.className || "")).attr({
    ...
    class oa {
        ...
        render() {
            ...
            let {axis: t, options: e} = this, {horiz: i, logarithmic: s} = t, {color: o, events: r, zIndex: a=0} = e, {renderer: n, time: h} = t.chart, l = {}, d = h.parse(e.to), c = h.parse(e.from), p = h.parse(e.value), g = e.borderWidth, u = e.label, {label: f, svgElem: m} = this, x = [], y, b = s7(c) && s7(d), v = s7(p), k = !m, w = {
                class: "H_L-plot-" + (b ? "band " : "line ") + (e.className || "")
            }, M = b ? "bands" : "lines";
        ...
        renderLabel(t, e, i, s) {
            ...
            n || (this.label = n = r.text(this.getLabelText(t), 0, 0, t.useHTML).attr({
                ...
                rotation: t.rotation,
                class: "H_L-plot-" + (i ? "band" : "line") + "-label " + (t.className || ""),
                zIndex: s
            }),
    ...
    class oO {
        ...
        getClassName(t, e, i) {
            let s = this.options
              , o = t.series
              , r = o.options;
            return [s.className, "H_L-label", i && "H_L-tooltip-header", e ? "H_L-tooltip-box" : "H_L-tooltip", !i && "H_L-color-" + oC(t.colorIndex, o.colorIndex), r?.className].filter(oS).join(" ")
        }
        getLabel({anchorX: t, anchorY: e}={
            ...
            if (this.label) {
                let t = !this.label.hasClass("H_L-label");
            ...
            if (!this.label) {
                if (this.outside) {
                    ...
                    a.className = "H_L-tooltip-container " + (t.renderTo.className.match(/(H_L[a-zA-Z0-9-]+)\s?/gm) || ""),
                    om(a, {
                        position: "absolute",
                        top: "1px",
                        pointerEvents: "none",
        ...
        shouldStickOnContact(t) {
            return !!(!this.followPointer && this.options.stickOnContact && (!t || this.pointer.inClass(t.target, "H_L-tooltip")))
        }
        move(t, e, i, s) {
        ...
        drawTracker() {
            ...
            this.tracker ? this.tracker.attr(s) : (this.tracker = e.renderer.rect(s).addClass("H_L-tracker").add(e),
            t.styledMode || this.tracker.attr({
                fill: "rgba(0,0,0,0)"
            }))
        }
        styledModeFormat(t) {
            return t.replace('style="font-size: 0.8em"', 'class="H_L-header"').replace(/style="color:{(point|series)\.color}"/g, 'class="H_L-color-{$1.colorIndex} {series.options.className} {point.options.className}"')
        }
    ...
    class oq {
        ...
        getClassName() {
            return "H_L-point" + (this.selected ? " H_L-point-select" : "") + (this.negative ? " H_L-negative" : "") + (this.isNull ? " H_L-null-point" : "") + (void 0 !== this.colorIndex ? " H_L-color-" + this.colorIndex : "") + (this.options.className ? " " + this.options.className : "") + (this.zone?.className ? " " + this.zone.className.replace("H_L-negative", "") : "")
        }
        getGraphicalProps(t) {
            let e, i, s = this, o = [], r = {
                singular: [],
        ...
        setState(t, e) {
            ...
            this.graphic && !this.hasMockGraphic) {
                if (s && this.graphic.removeClass("H_L-point-" + s),
                t && this.graphic.addClass("H_L-point-" + t),
                !d.styledMode) {
                    ...
                    i.options.inactiveOtherPoints && oj(e) && (this.dataLabels || []).forEach(function(t) {
                        t && !t.hasClass("H_L-data-label-hidden") && (t.animate({
                            opacity: e
                        }, f),
            ...
            p.attr({
                class: "H_L-halo H_L-color-" + o$(this.colorIndex, i.colorIndex) + (this.className ? " " + this.className : ""),
                visibility: v,
                zIndex: -1
            }),
            p.point = this,
    ...
    class rr {
        ...
        onTrackerMouseOut(t) {
            ...
            !s || !i || s.stickyTracking || this.inClass(i, "H_L-tooltip") || this.inClass(i, "H_L-series-" + s.index) && this.inClass(i, "H_L-tracker") || s.onMouseOut()
        }
        inClass(t, e) {
            let i = t, s;
            for (; i; ) {
        ...
        onContainerClick(t) {
            let e = this.chart
              ...
              , o = e.plotLeft
              , r = e.plotTop;
            !e.cancelClick && (i && this.inClass(s.target, "H_L-tracker") ? (o4(i.series, "click", o6(s, {
                point: i
            })),
        ...
        onContainerMouseLeave(t) {
            ...
            e && !this.inClass(t.relatedTarget, "H_L-tooltip") && (e.reset(),
        ...
        onContainerMouseMove(t) {
            ...
            !e.exporting?.openMenu && (this.inClass(s.target, "H_L-tracker") || e.isInsidePlot(s.chartX - e.plotLeft, s.chartY - e.plotTop, {
                visiblePlotOnly: !0
            })) && !i?.shouldStickOnContact(s) && (this.inClass(s.target, "H_L-no-tooltip") ? this.reset(!1, 0) : this.runPointActions(s))
        }
        ...
        onDocumentMouseMove(t) {
            ...
            !s || e.isInsidePlot(o.chartX - e.plotLeft, o.chartY - e.plotTop, {
                visiblePlotOnly: !0
            }) || i?.shouldStickOnContact(o) || o.target !== e.container.ownerDocument && this.inClass(o.target, "H_L-tracker") || this.reset()
        }
        onDocumentMouseUp(t) {
        ...
        pinch(t) {
            let e = this
              ...
              , a = r.length
              , n = 1 === a && (e.inClass(t.target, "H_L-tracker") && i.runTrackerClick || e.runChartClick)
              , h = i.tooltip
        ...
        setPointerCapture() {
            ...
            i.className += " H_L-no-touch-action",
            ...
            i.className = i.className.replace(" H_L-no-touch-action", ""),
    ...
    !function(t) {
        function e(t, e, i) {
            ...
            s.line = c.path().addClass("H_L-graph").attr(u).add(p),
            i && (s.area = c.path().addClass("H_L-area").add(p)),
        ...
        t.rectangle = function(t, e) {
            let i = e.legendItem || {}
              ...
              , r = s.squareSymbol
              , a = r ? o : t.symbolWidth;
            i.symbol = this.chart.renderer.rect(r ? (t.symbolWidth - o) / 2 : 0, t.baseline - o + 1, a, o, rf(t.options.symbolRadius, o / 2)).addClass("H_L-point").attr({
                zIndex: 3
            }).add(i.group)
        }
    }(c || (c = {}));
    ...
    class r0 {
        ...
        animate(t) {
            ...
            if (t && i) {
                ...
                i.clip(n),
                s?.clip(h)
            } else if (n && !n.hasClass("H_L-animating")) {
                let t = e.getClipBox(this)
                  , i = r.step;
                ...
                n.addClass("H_L-animating").animate(t, r)
            }
        }
        afterAnimate() {
            this.setClip(),
        ...
        plotGroup(t, e, i, s, o) {
            ...
            r.addClass("H_L-" + e + " H_L-series-" + this.index + " H_L-" + this.type + "-series " + (rN(this.colorIndex) ? "H_L-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (r.hasClass("H_L-tracker") ? " H_L-tracker" : ""), !0),
        ...
        drawTracker() {
            ...
            d ? d.attr({
                ...
                zIndex: 2
            }).addClass(i ? "H_L-tracker-area" : "H_L-tracker-line").add(t.group),
            o.styledMode || d.attr({
            ...
            [t.tracker, t.markerGroup, t.dataLabelsGroup].forEach(t => {
                t && (t.addClass("H_L-tracker").on("mouseover", h).on("mouseout", t => {
        ...
        setState(t, e) {
            ...
            i.state !== t && ([i.group, i.markerGroup, i.dataLabelsGroup].forEach(function(e) {
                e && (i.state && e.removeClass("H_L-series-" + i.state),
                t && e.addClass("H_L-series-" + t))
            }),
            i.state = t,
            !i.chart.styledMode)) {
    ...
    class ag {
        ...
        colorizeItem(t, e) {
            ...
            o?.[e ? "removeClass" : "addClass"]("H_L-legend-item-hidden"),
        ...
        renderItem(t) {
            let e = t.legendItem = t.legendItem || {}
              ...
              , y = e.label
              , b = a + n + d + 20 * !!f;
            !y && (e.group = s.g("legend-item").addClass("H_L-" + g.type + "-series H_L-color-" + t.colorIndex + (x ? " " + x : "") + (p ? " H_L-series-" + t.index : "")).attr({
                zIndex: 1
        ...
        render() {
            ...
            d || (this.box = d = e.rect().addClass("H_L-legend-box").attr({
                r: i.borderRadius
            }).add(h)),
            t.styledMode || d.attr({
        ...
        handleOverflow(t) {
            ...
            this.pager = s.text("", 15, 10).addClass("H_L-legend-navigation"),
        ...
        scroll(t, e) {
            ...
            [this.up, this.upTracker].forEach(function(t) {
                t.attr({
                    class: 1 === l ? "H_L-legend-nav-inactive" : "H_L-legend-nav-active"
                })
            }),
            n.attr({
                text: l + "/" + o
            ...
            [this.down, this.downTracker].forEach(function(t) {
                t.attr({
                    ...
                    class: l === o ? "H_L-legend-nav-inactive" : "H_L-legend-nav-active"
                })
            }, this),
        ...
        setItemEvents(t, e, i) {
            let s = this
              ...
              , a = t instanceof oK
              , n = t instanceof r1
              , h = "H_L-legend-" + (a ? "point" : "series") + "-active"
    ...
    class a0 {
        ...
        setClassName(t) {
            this.container.className = "H_L-container " + (t || "")
        }
        getContainer() {
            let t, e = this.options, i = e.chart, s = "data-H_L-chart", o = aQ(), r = this.renderTo, a = aZ(aP(r, s));
        ...
        drawChartBox() {
            ...
            m || (this.chartBackground = m = e.rect().addClass("H_L-background").add(),
            w = "attr"),
            ...
            w = "animate",
            x || (w = "attr",
            this.plotBackground = x = e.rect().addClass("H_L-plot-background").add()),
            x[w](g),
            !o && (x.attr({
                fill: n || "none"
            }).shadow(t.plotShadow),
            ...
            w = "animate",
            y || (w = "attr",
            this.plotBorder = y = e.rect().addClass("H_L-plot-border").attr({
                zIndex: 1
            }).add()),
            o || y.attr({
        ...
        addCredits(t) {
            ...
            i.enabled && !this.credits && (this.credits = this.renderer.text(i.text + (this.mapCredits || ""), 0, 0).addClass("H_L-credits").on("click", function() {
        ...
        destroy() {
            ...
            w.chartCount--,
            e.renderTo.removeAttribute("data-H_L-chart"),
            aq(e),
            t = i.length; t--; )
                i[t] = i[t].destroy();
        ...
        showLoading(t) {
            ...
            r || (e.loadingDiv = r = aL("div", {
                className: "H_L-loading H_L-loading-hidden"
            }, null, e.container)),
            a || (e.loadingSpan = a = aL("span", {
                className: "H_L-loading-inner"
            }, null, r),
            aA(e, "redraw", o)),
            r.className = "H_L-loading",
        ...
        hideLoading() {
            let t = this.options
              , e = this.loadingDiv;
            e && (e.className = "H_L-loading H_L-loading-hidden",
        ...
        showResetZoom() {
            ...
            aW(this, "beforeShowResetZoom", null, function() {
                ...
                }).addClass("H_L-reset-zoom").add().align(i.position, !1, o)
            }),
    ...
    class ni {
        ...
        constructor(t) {
            ...
            let n = this.parentDiv = a5("div", {
                className: "H_L-scrolling-parent"
            }, {
                position: "relative"
            }, t.renderTo)
              , h = this.scrollingContainer = a5("div", {
                className: "H_L-scrolling"
            }, a, n)
              , l = this.innerContainer = a5("div", {
                className: "H_L-inner-container"
            }, void 0, h)
            ...
            this.mask = c.path().attr({
                ...
                zIndex: -1
            }).addClass("H_L-scrollable-mask").add(),
        ...
        moveFixedElements() {
            ...
            if (s && !i ? t = ".H_L-yaxis" : s && i || o && !i ? t = ".H_L-xaxis" : o && i && (t = ".H_L-yaxis"),
            t && !(this.chart.hasParallelCoordinates && ".H_L-yaxis" === t))
                for (let e of [`${t}:not(.H_L-radial-axis)`, `${t}-labels:not(.H_L-radial-axis-labels)`])
                    a7(a, e);
            else
                for (let t of [".H_L-xaxis", ".H_L-yaxis"])
                    for (let e of [`${t}:not(.H_L-radial-axis)`, `${t}-labels:not(.H_L-radial-axis-labels)`])
                        a4(a, e);
            for (let t of a)
    ...
    ni.fixedSelectors = [".H_L-breadcrumbs-group", ".H_L-contextbutton", ".H_L-caption", ".H_L-credits", ".H_L-drillup-button", ".H_L-legend", ".H_L-legend-checkbox", ".H_L-navigator-series", ".H_L-navigator-xaxis", ".H_L-navigator-yaxis", ".H_L-navigator", ".H_L-range-selector-group", ".H_L-reset-zoom", ".H_L-scrollbar", ".H_L-subtitle", ".H_L-title"];
    let {format: ns} = ep
      , {series: no} = rk
    ...
    class nB extends r1 {
        drawGraph() {
            ...
            [this, ...this.zones].forEach( (s, o) => {
                ...
                a.animate({
                    d: e
                })) : e.length && (s.graph = a = this.chart.renderer.path(e).addClass("H_L-graph" + (o ? ` H_L-zone-graph-${o - 1} ` : " ") + (o && s.className || "")).attr({
                    zIndex: 1
                }).add(this.group)),
                a && !i && (r = {
    ...
    class nF extends nN {
        drawGraph() {
            ...
            [this, ...this.zones].forEach( (i, s) => {
                ...
                (a = i.area = this.chart.renderer.path(t).addClass("H_L-area" + (s ? ` H_L-zone-area-${s - 1} ` : " ") + (s && i.className || "")).add(this.group)).isArea = !0),
    ...
    class ht extends r1 {
        ...
        drawGraph() {
            this.group[this.dense ? "addClass" : "removeClass"]("H_L-dense-data")
        }
        pointAttribs(t, e) {
        ...
        drawTracker(t=this.points) {
            let e, i = this, s = i.chart, o = s.pointer, r = function(t) {
                ...
                o && e && i.options.enableMouseTracking && (s.isInsidePlot(t.chartX - s.plotLeft, t.chartY - s.plotTop, {
                    visiblePlotOnly: !0
                }) || o?.inClass(t.target, "H_L-data-label")) && (o.isDirectTouch = !0,
                e.onMouseOver(t))
            };
            t.forEach(function(t) {
            ...
            i._hasTracking || (i.trackerGroups.forEach(function(t) {
                i[t] && (i[t].addClass("H_L-tracker").on("mouseover", r).on("mouseout", function(t) {
        ...
        function r(t) {
            ...
            t.forEach(t => {
                ...
                hu(n(c, t.dlOptions || t.options?.dataLabels)).forEach( (n, l) => {
                    ...
                    k = !0),
                    c && ho(x) && "" !== x && (v ? b.text = x : (v = r.label(x, 0, 0, n.shape, void 0, void 0, n.useHTML, void 0, "data-label")).addClass(" H_L-data-label-color-" + t.colorIndex + " " + (n.className || "") + (n.useHTML ? " H_L-tracker" : "")),
                    v && (v.options = n,
                    v.attr(b),
    ...
    class hK extends r1 {
        ...
        drawEmpty() {
            ...
            e = this.center[1],
            this.graph || (this.graph = this.chart.renderer.arc(t, e, this.center[1] / 2, 0, i, s).addClass("H_L-empty-series").add(this.group)),
            this.graph.attr({
            ...
            this.points.forEach(e => {
                (e.dataLabels || []).forEach(s => {
                    ...
                    if (r) {
                        ...
                        g = s.connector,
                        a && a.distance > 0 ? (n = !g,
                        g || (s.connector = g = i.renderer.path().addClass("H_L-data-label-connector  H_L-color-" + e.colorIndex + (e.className ? " " + e.className : "")).add(t.dataLabelsGroup)),
                        i.styledMode || g.attr({
                            "stroke-width": r,
    ...
    function la(t, e) {
        ...
        t.oldOpacity !== i && (t.hasClass("H_L-data-label") ? (t[i ? "removeClass" : "addClass"]("H_L-data-label-hidden"),
        s = !0,
