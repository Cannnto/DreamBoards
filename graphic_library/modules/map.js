!/**
 * H_U JS v12.3.0 (2025-06-21)
 * @module H_L/modules/color-axis
 * @requires H_L
 *
 * ColorAxis module
 *
 ...
 *
 * License: www.H_L.com/license
 */
function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(t._H_U, t._H_U.Axis, t._H_U.Color, t._H_U.LegendSymbol, t._H_U.SeriesRegistry, t._H_U.SVGElement, t._H_U.Series, t._H_U.Chart, t._H_U.SVGRenderer, t._H_U.Templating, t._H_U.Series.types.scatter, t._H_U.Point) : "function" == typeof define && define.amd ? define("H_L/modules/map", ["H_L/H_L"], function(t) {
        return e(t, t.Axis, t.Color, t.LegendSymbol, t.SeriesRegistry, t.SVGElement, t.Series, t.Chart, t.SVGRenderer, t.Templating, t.Series, ["types"], ["scatter"], t.Point)
    }) : "object" == typeof exports ? exports["H_L/modules/map"] = e(t._H_U, t._H_U.Axis, t._H_U.Color, t._H_U.LegendSymbol, t._H_U.SeriesRegistry, t._H_U.SVGElement, t._H_U.Series, t._H_U.Chart, t._H_U.SVGRenderer, t._H_U.Templating, t._H_U.Series.types.scatter, t._H_U.Point) : t.H_U = e(t.H_U, t.H_U.Axis, t.H_U.Color, t.H_U.LegendSymbol, t.H_U.SeriesRegistry, t.H_U.SVGElement, t.H_U.Series, t.H_U.Chart, t.H_U.SVGRenderer, t.H_U.Templating, t.H_U.Series.types.scatter, t.H_U.Point)
    ...
    w.d = (t, e) => {
        for (var i in e)
            w.o(e, i) && !w.o(t, i) && Object.defineProperty(t, i, {
                enumerable: !0,
                get: e[i]
            })
    }
    ...
    !function(t) {
        ...
        function i() {
            ...
            this.colorAxis = [],
            t.colorAxis && (t.colorAxis = D(t.colorAxis),
        ...
        t.compose = function(t, c, u, m, g) {
            let f = c.prototype
              , b = u.prototype
              , y = g.prototype;
            f.collectionsWithUpdate.includes("colorAxis") || (e = t,
    ...
    !function(t) {
        t.initDataClasses = function(t) {
            ...
            for (let t = 0, i = o.length; t < i; ++t)
                ...
                r.color = h[l]),
                r.colorIndex = l,
                ++l === n && (l = 0)) : r.color = O(s.minColor).tweenTo(O(s.maxColor), i < 2 ? .5 : t / (i - 1)))
        }
        ,
    ...
    let {defaultOptions: Y} = L()
      , {series: U} = W()
      , {defined: F, extend: Z, fireEvent: _, isArray: K, isNumber: q, merge: $, pick: J, relativeLength: Q} = L();
    Y.colorAxis = $(Y.xAxis, {
        lineWidth: 0,
        minPadding: 0,
        maxPadding: 0,
    ...
    class tt extends A() {
        ...
        init(t, e) {
            ...
            this.userOptions = e,
            K(t.userOptions.colorAxis) && (t.userOptions.colorAxis[this.index] = e),
        ...
        drawLegendSymbol(t, e) {
            ...
            i.labelWidth = l + s + (n ? a : J(r.x, r.distance) + (this.maxLabelLength || 0)),
        ...
        getSeriesExtremes() {
            ...
            this.dataMax = -1 / 0; r--; ) {
                for (let a of (i = (o = t[r]).colorKey = J(o.options.colorKey, o.colorKey, o.pointValKey, o.zoneAxis, "y"),
                s = o[i + "Min"] && o[i + "Max"],
                [i, "value", "y"]))
                ...
                F(o.minColorValue) && F(o.maxColorValue) && (this.dataMin = Math.min(this.dataMin, o.minColorValue),
        ...
        drawCrosshair(t, e) {
            ...
            e.plotX = o,
            e.plotY = r,
            this.cross && !this.cross.addedToColorAxis && s.group && (this.cross.addClass("H_L-coloraxis-marker").add(s.group),
        ...
        getPlotLinePath(t) {
            let e = this.left
              , i = t.translatedValue
              , s = this.top;
            return q(i) ? this.horiz ? [["M", i - 4, s - 6], ["L", i + 4, s - 6], ["L", i, s], ["Z"]] : [["M", e, i], ["L", e - 6, i + 6], ["L", e - 6, i - 6], ["Z"]] : super.getPlotLinePath(t)
        }
        update(t, e) {
            let i = this.chart.legend;
            this.series.forEach(t => {
        ...
        getDataClassLegendSymbols() {
            let t, e = this, i = e.chart, s = e.legendItem && e.legendItem.labels || [], o = i.options.legend, r = J(o.valueDecimals, -1), a = J(o.valueSuffix, ""), n = t => e.series.reduce( (e, i) => (e.push(...i.points.filter(e => e.dataClass === t)),
            e), []);
    ...
    !function(t) {
        ...
        function s(t) {
            let e = this.chart;
            t = this.normalize(t),
            e.options.mapNavigation.enableDoubleClickZoomTo ? e.pointer.inClass(t.target, "H_L-tracker") && e.hoverPoint && e.hoverPoint.zoomTo() : e.isInsidePlot(t.chartX - e.plotLeft, t.chartY - e.plotTop) && e.mapZoom(.5, void 0, void 0, t.chartX, t.chartY)
        }
        function o(t) {
            let s = this.chart
              , o = ts((t = this.normalize(t)).wheelDelta) && -t.wheelDelta / 120 || t.deltaY || t.detail;
        ...
        function a(t) {
            ...
            e && tr(e.enableTouchZoom, e.enabled) && (this.chart.zooming.pinchType = "xy"),
    ...
    let tp = {
        compose: function(t) {
            (c = t.prototype.symbols).bottombutton = tl,
            c.topbutton = th
        }
    }
      , {setOptions: td} = L()
      , {composed: tc} = L()
      , {addEvent: tu, extend: tm, merge: tg, objectEach: tf, pick: tb, pushUnique: ty} = L();
    function tx(t) {
        t && (t.preventDefault?.(),
        t.stopPropagation?.(),
        t.cancelBubble = !0)
    ...
    class tM {
        static compose(t, e, i) {
            tn.compose(e),
            tp.compose(i),
            ty(tc, "Map.Navigation") && (tu(t, "beforeRender", function() {
        ...
        update(t) {
            ...
            for (t && (r = i.options.mapNavigation = tg(i.options.mapNavigation, t)); s.length; )
                s.pop()?.destroy();
            if (!i.renderer.forExport && tb(r.enableButtons, r.enabled)) {
                ...
                tf(r.buttons, (t, a) => {
                    ...
                    !i.styledMode && t.theme && (tm(n, t.theme),
                    n.style = tg(t.theme.style, t.style));
                    let {text: l, width: h=0, height: p=0, padding: d=0} = t
                      , c = i.renderer.button("+" !== l && "-" !== l && l || "", 0, 0, o, n, void 0, void 0, void 0, "zoomIn" === a ? "topbutton" : "bottombutton").addClass("H_L-map-navigation H_L-" + ({
                        zoomIn: "zoom-in",
                        zoomOut: "zoom-out"
                    })[a]).attr({
                        width: h,
                    ...
                    if ("+" === l || "-" === l) {
                        let e = h + 1
                          , s = [["M", d + 3, d + p / 2], ["L", d + e - 3, d + p / 2]];
                        "+" === l && s.push(["M", d + e / 2, d + 3], ["L", d + e / 2, d + p - 3]),
                        i.renderer.path(s).addClass("H_L-button-symbol").attr(i.styledMode ? {} : {
                            stroke: t.style?.color,
                            "stroke-width": 3,
                            "stroke-linecap": "round"
                        }).add(c)
                    }
                    if (c.handler = t.onclick,
                    ...
                    i.hasLoaded)
                        ...
                        let e = tu(i, "load", () => {
                            c.element && c.align(t, !1, t.alignTo),
                            e()
                        }
                        )
                    }
        ...
        updateEvents(t) {
            ...
            tb(t.enableMouseWheelZoom, t.enabled) ? this.unbindMouseWheel = this.unbindMouseWheel || tu(e.container, "wheel", function(t) {
                if (!e.pointer.inClass(t.target, "H_L-no-mousewheel")) {
    ...
    var tv = w(28)
      , tw = w.n(tv);
    let {column: {prototype: tC}} = W().seriesTypes
    ...
    !function(t) {
        ...
        t.seriesMembers = {
            ...
            colorAttribs: function(t) {
                let e = {};
                return tL(t.color) && (!t.state || "normal" === t.state) && (e[this.colorProp || "fill"] = t.color),
                e
            },
            pointAttribs: tC.pointAttribs
        },
        t.compose = function(t) {
            return tT(t.prototype.pointClass, "afterSetState", e),
            t
        }
    }(f || (f = {}));
    let tP = f;
    ...
    !function(t) {
        t.getCenter = function() {
            ...
            let u = [tI(r?.[0], "50%"), tI(r?.[1], "50%"), tI(h && h < 0 ? void 0 : t.size, "100%"), tI(p && p < 0 ? void 0 : t.innerSize || 0, "0%")];
            for (!e.angular || this instanceof tk() || (u[3] = 0),
            d = 0; d < 4; ++d)
                c = u[d],
                l = d < 2 || 2 === d && /%$/.test(c),
    ...
    class tW extends tV() {
        ...
        mapZoom(t, e, i, s, o) {
            this.mapView && (tX(t) && (t = Math.log(t) / Math.log(.5)),
            this.mapView.zoomBy(t, tX(e) && tX(i) ? this.mapView.projection.inverse([e, i]) : void 0, tX(s) && tX(o) ? [s, o] : void 0))
        }
        update(t) {
    ...
    !function(t) {
        ...
        function s(t, e) {
            ...
            if (!i)
                return void t3(21, !1, this);
            let {jsonmarginX: s=0, jsonmarginY: o=0, jsonres: r=1, scale: a=1, xoffset: n=0, xpan: l=0, yoffset: h=0, ypan: p=0} = e
    ...
    function et(t, e, i=!0) {
        ...
        for (let t = 0; t < e.length; t++) {
            ...
            for (let t = 0; t < l.length; t++)
                ee(s, o, a = l[t]) ? (ee(s, o, r) || n.push(ei(s, o, r, a)),
                n.push(a)) : ee(s, o, r) && n.push(ei(s, o, r, a)),
                r = a;
            s = o
        }
        return n
    ...
    let es = Math.sign || (t => 0 === t ? 0 : t > 0 ? 1 : -1)
      ...
      , eh = class {
        ...
        forward(t) {
            let e = Math.PI / 180
              ...
              , s = i * i
              , o = s * s * s;
            return [t[0] * e * Math.cos(i) * 74.03120656864502 / (el * (1.340264 + -.24331799999999998 * s + o * (.0062510000000000005 + .034164 * s))), 74.03120656864502 * i * (1.340264 + -.081106 * s + o * (893e-6 + .003796 * s))]
        }
        inverse(t) {
            ...
            !(1e-9 > Math.abs(l))); ++t)
                ;
            a = (r = o * o) * r * r;
            let h = s * el * e * (1.340264 + -.24331799999999998 * r + a * (.0062510000000000005 + .034164 * r)) / Math.cos(o)
      ...
      , ec = class {
        ...
        forward(t) {
            return [t[0] * ed * 63.78137, 79.7267125 * Math.log(Math.tan(ep + .4 * t[1] * ed))]
        }
        inverse(t) {
            return [t[0] / 63.78137 / ed, 2.5 * (Math.atan(Math.exp(.8 * (t[1] / 63.78137))) - ep) / ed]
        }
    }
      , eu = Math.PI / 180
      , em = class {
        ...
        forward(t) {
            let e = t[0]
              , i = t[1] * eu
              , s = [Math.cos(i) * Math.sin(e * eu) * 63.78460826781007, 63.78460826781007 * Math.sin(i)];
        ...
        inverse(t) {
            let e = t[0] / 63.78460826781007
              ...
              , o = Math.asin(s)
              , r = Math.sin(o);
            return [Math.atan2(e * r, s * Math.cos(o)) / eu, Math.asin(s && i * r / s) / eu]
        }
    }
      , eg = Math.PI / 180
      , ef = class {
        ...
        forward(t) {
            let e = Math.sin(t[1] * eg)
              , i = [63.78137 * t[0] * eg, 63.78137 * Math.log((1 + e) / (1 - e)) / 2];
            return Math.abs(t[1]) > this.maxLatitude && (i.outside = !0),
            i
        }
        inverse(t) {
            return [t[0] / (63.78137 * eg), (2 * Math.atan(Math.exp(t[1] / 63.78137)) - Math.PI / 2) / eg]
        }
    }
    ...
    class eL {
                ...
                return {
                    forward: t => {
                        let i = t[0] * ev + e
                          ...
                          , d = Math.sin(s)
                          , c = d * o + h * r;
                        return [Math.atan2(p * a - c * n, h * o - d * r) / ev, Math.asin(c * a + p * n) / ev]
                    }
                    ,
                    inverse: t => {
                        let i = t[0] * ev
                          ...
                          , d = Math.sin(s)
                          , c = d * a - p * n;
                        return [(Math.atan2(p * a + d * n, h * o + c * r) - e) / ev, Math.asin(c * o - h * r) / ev]
                    }
                }
        }
        forward(t) {
        ...
        cutOnAntimeridian(t, e) {
            ...
            for (let i = 0, o = t.length; i < o; ++i) {
                ...
                if ((a < -90 || a > 90) && (n < -90 || n > 90) && a > 0 != n > 0) {
                    let t = ex((180 - (a + 360) % 360) / ((n + 360) % 360 - (a + 360) % 360), 0, 1)
                      , e = r[1] + t * (o[1] - r[1]);
                    s.push({
                        i,
                        lat: e,
                ...
                if (e) {
                    ...
                    for (; e >= 0; ) {
                        let i = s[e].i
                          ...
                          , n = t.splice(i, s[e + 1].i - i, ...eL.geodesic([r, s[e].lat], [r, s[e + 1].lat], !0));
                    ...
                    for (; e--; ) {
                        let i = s[e].i
                          , r = t.splice(i, t.length, [ew(180 + 1e-6 * s[e].direction), s[e].lat]);
        ...
        path(t) {
            let e, {bounds: i, def: s, rotator: o} = this, r = [], a = "Polygon" === t.type || "MultiPolygon" === t.type, n = this.hasGeoProjection, l = !s || !1 !== s.antimeridianCutting, h = l ? o : void 0, p = l && s || this;
                ...
                o.forEach(t => {
                    ...
                    if (l) {
                        ...
                        for (let e = 0; e < g.length; e++) {
                            let i = t[e]
                              , r = g[e];
                            r.outside ? d = !0 : (a && !s && (s = i,
                            t.push(i),
                            g.push(r)),
                            d && o && (a && n ? eL.geodesic(o, i).forEach(t => c(p.forward(t))) : h = !1),
                            c(r),
                            o = i,
                            d = !1)
                        }
            ...
            ;
            return "LineString" === t.type ? d(t.coordinates) : "MultiLineString" === t.type ? t.coordinates.forEach(t => d(t)) : "Polygon" === t.type ? (t.coordinates.forEach(t => d(t)),
    ...
    let {composed: eP} = L()
      ...
      , {addEvent: ez, clamp: eS, crisp: eI, fireEvent: eB, isArray: eE, isNumber: eD, isObject: eV, isString: eO, merge: eN, pick: eG, pushUnique: eX, relativeLength: eR} = L()
      , eH = {};
    function eW(t, e) {
    ...
    class eU {
        static compose(t) {
            eX(eP, "MapView") && (eH = t.maps,
            ez(t, "afterInit", function() {
        ...
        constructor(t, e) {
            ...
            this instanceof eF || this.recommendMapView(t, [t.options.chart.map, ...(t.options.series || []).map(t => t.mapData)]),
            this.userOptions = e || {};
            ...
            this.createInsets(),
            this.eventsToUnbind.push(ez(t, "afterSetChartSize", () => {
                this.playingField = this.getField(),
                (void 0 === this.minZoom || this.minZoom === this.zoom) && (this.fitToBounds(void 0, void 0, !1),
                !this.chart.hasRendered && eD(this.userOptions.zoom) && (this.zoom = this.userOptions.zoom),
                this.userOptions.center && eN(!0, this.center, this.userOptions.center))
            }
            )),
            this.setUpEvents()
        }
        ...
        fitToBounds(t, e, i=!0, s) {
            ...
            if (o) {
                let r = eG(e, t ? 0 : this.options.padding)
                  , a = this.getField(!1)
                  , n = eE(r) ? r : [r, r, r, r];
                this.padding = [eR(n[0], a.height), eR(n[1], a.width), eR(n[2], a.height), eR(n[3], a.width)],
                this.playingField = this.getField();
            ...
            if (i) {
                if (!this.fitToGeometryCache)
                    if ("MultiPoint" === i.type) {
                        ...
                        this.fitToGeometryCache = ej(t.path(i));
        ...
        projectedUnitsToLonLat(t) {
            ...
            if (i) {
                for (let s in i)
                    if (Object.hasOwnProperty.call(i, s) && i[s].hitZone && eA(t, i[s].hitZone.coordinates[0]))
            ...
            if (o) {
                ...
                if (!this.chart.series.some(t => t.isDrilling)) {
                    let o = n.x
                      ...
                      , d = l.x
                      , c = n.y;
                    d - o < s ? t[0] = h[0] : o < e && d < e + s ? t[0] += Math.max(o - e, d - s - e) / a : d > e + s && o > e && (t[0] += Math.min(d - s - e, o - e) / a),
                    c - p < r ? t[1] = h[1] : p < i && c < i + r ? t[1] -= Math.max(p - i, c - r - i) / a : c > i + r && p > i && (t[1] -= Math.min(c - r - i, p - i) / a),
        ...
        setUpEvents() {
            let t, e, i, {chart: s} = this, o = o => {
                ...
                p = a[0].chartY) : a?.length === 2 && (h = (a[0].chartX + a[1].chartX) / 2,
                p = (a[0].chartY + a[1].chartY) / 2),
                l?.length === 2 && r && (d = Math.log(Math.sqrt(Math.pow(r[0].chartX - r[1].chartX, 2) + Math.pow(r[0].chartY - r[1].chartY, 2)) / Math.sqrt(Math.pow(l[0].chartX - l[1].chartX, 2) + Math.pow(l[0].chartY - l[1].chartY, 2))) / Math.log(.5)),
                eD(h) && eD(p)) {
                    let r = `${h},${p}`
                    ...
                    if ("Orthographic" === n.options.name && 2 > (l?.length || 0) && (this.minZoom || 1 / 0) < 1.3 * m) {
                        ...
                        let e = this.getScale()
                          ...
                          , s = this.projection.inverse([t[0] + (h - a) / e, t[1] - (p - c) / e * i]);
        ...
        update(t, e=!0, i) {
            ...
            r && this.createInsets(),
            !t.center && Object.hasOwnProperty.call(t, "zoom") && !eD(t.zoom) && this.fitToBounds(void 0, void 0, !1)),
            t.center || eD(t.zoom) ? this.setView(this.options.center, t.zoom, !1) : "fitToGeometry"in t && this.fitToBounds(void 0, void 0, !1),
    ...
    class eF extends eU {
        ...
        getHitZone() {
            ...
            if (s) {
                ...
                if ("percent" === i.units) {
                    ...
                    o = o.map(t => [eR(`${t[0]}%`, s.width, s.x), eR(`${t[1]}%`, s.height, s.y)])
                }
                return {
                    type: "Polygon",
                    coordinates: [o]
        ...
        render() {
            ...
            if (s && e.group) {
                let o = !0;
                this.border || (this.border = t.renderer.path().addClass("H_L-mapview-inset-border").add(e.group),
                o = !1),
                ...
                let r = this.border.strokeWidth()
                  ...
                  , n = (s.coordinates || []).reduce( (e, s) => s.reduce( (e, s, o) => {
                    let[n,l] = s;
                    return "percent" === i.units && (n = t.plotLeft + eR(`${n}%`, a.width, a.x),
    ...
    let {animObject: eZ, stop: e_} = L()
      ...
      , {extend: eQ, find: e0, fireEvent: e1, getNestedProperty: e2, isArray: e6, defined: e3, isNumber: e8, isObject: e7, merge: e9, objectEach: e4, pick: e5, splat: it} = L();
    class ie extends eJ {
        constructor() {
            super(...arguments),
            this.processedData = []
            ...
            if (o) {
                ...
                this.points.forEach(i => {
                    ...
                    if (s) {
                        let o = s.animate
                          , r = "";
                        i.name && (r += "H_L-name-" + i.name.replace(/ /g, "-").toLowerCase()),
                        i.properties?.["hc-key"] && (r += " H_L-key-" + i.properties["hc-key"].toString().toLowerCase()),
                        r && s.addClass(r),
                        ...
                        s.animate = function(i, r, a) {
                            ...
                            if (n || l) {
                                let o = e5(t.getStrokeWidth(t.options), 1) / (e.mapView?.getScale() || 1);
                                n && (s["stroke-width"] = o),
                                l && (i["stroke-width"] = o)
                            }
            ...
            if (!this.bounds && this.chart.mapView) {
                ...
                (this.points || []).forEach(s => {
                    if (s.path || s.geometry) {
                        if ("string" == typeof s.path ? s.path = eq(s.path) : e6(s.path) && "M" === s.path[0] && (s.path = this.chart.renderer.pathToSegments(s.path)),
                        !s.bounds) {
        ...
        pointAttribs(t, e) {
            let {mapView: i, styledMode: s} = t.series.chart
              , o = s ? this.colorAttribs(t) : e$.prototype.pointAttribs.call(this, t, e)
              , r = this.getStrokeWidth(t.options);
            if (e) {
                let i = e9(this.options.states && this.options.states[e], t.options.states && t.options.states[e] || {})
            ...
            return o.dashstyle && i && e8(a) && (r = a / i.getScale()),
        ...
        processData() {
            let t, e, i, s = this.options, o = s.data, r = this.chart, a = r.options.chart, n = this.joinBy, l = s.keys || this.pointArrayMap, h = [], p = {}, d = this.chart.mapView, c = d && (e7(s.mapData, !0) ? d.getGeoMap(s.mapData) : d.geoMap), u = r.mapTransforms = a.mapTransforms || c?.["hc-transform"] || r.mapTransforms;
            u && e4(u, t => {
                t.rotation && (t.cosAngle = Math.cos(t.rotation),
                t.sinAngle = Math.sin(t.rotation))
            }
            ),
            e6(s.mapData) ? i = s.mapData : c && "FeatureCollection" === c.type && (this.mapTitle = c.title,
            ...
            if (o) {
                ...
                for (let e = 0, i = o.length; e < i; ++e) {
                    if (e8(t = o[e]))
                        ...
                        let i = 0;
                        m[e] = {},
                        !s.keys && t.length > l.length && "string" == typeof t[0] && (m[e]["hc-key"] = t[0],
                        ++i);
                        for (let s = 0; s < l.length; ++s,
                        ++i)
                            l[s] && void 0 !== t[i] && (l[s].indexOf(".") > 0 ? t$.prototype.setNestedProperty(m[e], t[i], l[s]) : m[e][l[s]] = t[i])
                    } else
                        m[e] = o[e];
                    n && "_i" === n[0] && (m[e]._i = e)
                }
        ...
        translate() {
            ...
            this.generatePoints(),
            delete this.bounds,
            !e || e.userOptions.center || e8(e.userOptions.zoom) || e.zoom !== e.minZoom ? this.getProjectedBounds() : e.fitToBounds(void 0, void 0, !1)),
            e) {
                let s = e.getSVGTransform();
                this.points.forEach(o => {
                    let r = e8(o.insetIndex) && e.insets[o.insetIndex].getSVGTransform() || s;
                    r && o.bounds && e8(o.bounds.midX) && e8(o.bounds.midY) && (o.plotX = o.bounds.midX * r.scaleX + r.translateX,
    ...
    class iy extends ic {
        constructor() {
            super(...arguments),
            this.clearBounds = id.prototype.clearBounds
        }
        drawDataLabels() {
            super.drawDataLabels(),
            this.dataLabelsGroup && this.dataLabelsGroup.clip(this.chart.clipRect)
        ...
        translate() {
            ...
            t) {
                ...
                this.points.forEach(s => {
                    ...
                    a = s.bounds.midY,
                    n && ig(r) && ig(a) && (s.plotX = r * n.scaleX + n.translateX,
    ...
    let ix = {
      ...
      , {noop: iM} = L()
      , {arrayMax: iv, arrayMin: iw, isNumber: iC, merge: iT, pick: iL, stableSort: iP} = L()
      , iA = class {
        constructor(t, e) {
            this.setState = iM,
            this.init(t, e)
        ...
        drawLegendSymbol(t) {
            let e, i = iL(t.options.itemDistance, 20), s = this.legendItem || {}, o = this.options, r = o.ranges, a = o.connectorDistance;
        ...
        setOptions() {
            ...
            t.forEach(function(h, p) {
                l || (o.stroke = iL(h.borderColor, e.borderColor, i.color),
        ...
        renderRange(t) {
            ...
            l.bubbleItems.push(n.circle(b, p + x, d).attr(M ? {} : t.bubbleAttribs).addClass((M ? "H_L-color-" + a.colorIndex + " " : "") + "H_L-bubble-legend-symbol " + (s.className || "")).add(this.legendItem.symbol)),
            l.connectors.push(n.path(n.crispLine([["M", b, y], ["L", b + v, y]], s.connectorWidth)).attr(M ? {} : t.connectorAttribs).addClass((M ? "H_L-color-" + this.options.seriesIndex + " " : "") + "H_L-bubble-legend-connectors " + (s.connectorClassName || "")).add(this.legendItem.symbol));
            let w = n.text(this.formatLabel(t)).attr(M ? {} : t.labelAttribs).css(M ? {} : o.style).addClass("H_L-bubble-legend-labels " + (s.labels.className || "")).add(this.legendItem.symbol)
              , C = {
                x: b + v + s.labels.x,
        ...
        getRanges() {
            ...
            return e.forEach(function(t) {
                t.isBubble && !t.ignoreSeries && (o = t.getColumn("z").filter(iC)).length && (r = iL(t.options.zMin, Math.min(r, Math.max(iw(o), !1 === t.options.displayNegative ? t.options.zThreshold : -Number.MAX_VALUE))),
        ...
        predictBubbleSizes() {
            ...
            return i || !/%$/.test(u) ? c = p : (c = (d + o) * (u = parseFloat(u)) / 100 / (u / 100 + 1),
            (s && a - c >= r || !s && r - c >= a) && (c = p)),
            [h, Math.ceil(c)]
        }
        updateRanges(t, e) {
    ...
    function iE(t, e, i) {
        let s, o, r, a = this.legend, n = iD(this) >= 0;
    ...
    var iR = w(260)
      , iH = w.n(iR);
    let {seriesTypes: {scatter: {prototype: {pointClass: iW}}}} = W()
      , {extend: iY} = L();
    class iU extends iW {
        haloPath(t) {
    ...
    let iF = iU
      ...
      , {series: iK, seriesTypes: {column: {prototype: iq}, scatter: i$}} = W()
      , {addEvent: iJ, arrayMax: iQ, arrayMin: i0, clamp: i1, extend: i2, isNumber: i6, merge: i3, pick: i8, pushUnique: i7} = L();
    function i9() {
        ...
        [["min", "userMin", r], ["max", "userMax", a]].forEach(t => {
            void 0 === i8(this.options[t[0]], this[t[1]]) && (this[t[0]] += t[2] / n)
        }
        )))
    }
    function i4() {
    ...
    class i5 extends i$ {
        static compose(t, e, i) {
            iX.compose(e, i),
            i7(iZ, "Series.Bubble") && (iJ(t, "foundExtremes", i9),
            iJ(t, "afterRender", i4))
        }
        animate(t) {
            ...
            if (!a) {
                ...
                this.chart.series.forEach(s => {
                    if (s.bubblePadding && s.reserveSpace()) {
                        ...
                        o && (e = Math.min(i8(e, o.zMin), o.zMin),
        ...
        markerAttribs(t, e) {
            ...
            return this.chart.inverted ? i2(i, {
                x: (t.plotX || 0) - o / 2,
                y: (t.plotY || 0) - s / 2
            }) : i
        }
        ...
        translateBubble() {
            ...
            for (; o--; ) {
                ...
                i6(a) && a >= s / 2 ? (r.marker = i2(r.marker, {
                    radius: a,
                    width: 2 * a,
                    height: 2 * a
                }),
        ...
        getZExtremes() {
            ...
            if (e.length) {
                let i = i8(t.zMin, i1(i0(e), !1 === t.displayNegative ? t.zThreshold || 0 : -Number.MAX_VALUE, Number.MAX_VALUE))
                  , s = i8(t.zMax, iQ(e));
                if (i6(i) && i6(s))
                    return {
                        zMin: i,
    ...
    let st = i5
      , {seriesTypes: {map: {prototype: {pointClass: {prototype: se}}}}} = W()
      , {extend: si} = L();
    class ss extends iF {
        isValid() {
    ...
    let {seriesTypes: {map: {prototype: so}, mappoint: {prototype: sr}}} = W()
      , {extend: sa, merge: sn} = L();
    class sl extends st {
        constructor() {
            super(...arguments),
            this.clearBounds = so.clearBounds
        }
        searchPoint(t, e) {
    ...
    let {scatter: {prototype: {pointClass: sh}}} = W().seriesTypes
    ...
    class sm extends sh {
        ...
        getCellAttributes() {
            let t = this.series
              ...
              , h = {
                x1: sp(Math.round(o.len - o.translate(this.x - i, !1, !0, !1, !0, -n)), -o.len, 2 * o.len),
                x2: sp(Math.round(o.len - o.translate(this.x + i, !1, !0, !1, !0, -n)), -o.len, 2 * o.len),
                y1: sp(Math.round(r.translate(this.y - s, !1, !0, !1, !0)), -r.len, 2 * r.len),
                y2: sp(Math.round(r.translate(this.y + s, !1, !0, !1, !0)), -r.len, 2 * r.len)
            };
    ...
    let {isNumber: sg} = L()
      ...
      , {series: sx, seriesTypes: {column: sM, scatter: sv}} = W()
      , {prototype: {symbols: sw}} = tN()
      , {addEvent: sC, extend: sT, fireEvent: sL, isNumber: sP, merge: sA, pick: sk} = L()
      , {colorFromPoint: sj, getContext: sz} = {
        colorFromPoint: function(t, e) {
            let i = e.series.colorAxis;
            if (i) {
                let s = i.toColor(t || 0, e).split(")")[0].split("(")[1].split(",").map(t => sy(parseFloat(t), parseInt(t, 10)));
                return s[3] = 255 * sy(s[3], 1),
        ...
        getContext: function(t) {
            ...
            i) : (t.canvas = sf.createElement("canvas"),
    ...
    class sS extends sv {
        ...
        drawPoints() {
            ...
            if (i) {
                ...
                if (!e || t.isDirtyData || t.isDirtyCanvas) {
                    let a = sz(t)
                      , {canvas: l, options: {colsize: p=1, rowsize: d=1}, points: c, points: {length: u}} = t
                    ...
                    if (l && a && m) {
                        let {min: m, max: g} = s.getExtremes()
                          ...
                          , [w,C] = [[M, M / y, r, "ceil"], [v, v / x, !n, "floor"]].map( ([t,e,i,s]) => i ? i => Math[s](t - e * i) : t => Math[s](e * t))
                          , T = l.width = M + 1
                          , L = T * (l.height = v + 1)
                          , P = (u - 1) / L
                ...
                (s.enabled || t._hasPointMarkers) && (sx.prototype.drawPoints.call(t),
                t.points.forEach(e => {
                    e.graphic && (e.graphic[t.chart.styledMode ? "css" : "animate"](t.colorAttribs(e)),
                    null === e.value && e.graphic.addClass("H_L-null-point"))
                }
                ))
        }
        getExtremes() {
            let {dataMin: t, dataMax: e} = sx.prototype.getExtremes.call(this, this.getColumn("value"));
            return sP(t) && (this.valueMin = t),
        ...
        pointAttribs(t, e) {
            ...
            i["stroke-width"] = l,
            e && "normal" !== e) {
                let o = sA(s.states?.[e], s.marker?.states?.[e], t?.options.states?.[e] || {});
                i.fill = o.color || j().parse(i.fill).brighten(o.brightness || 0).get(),
 ...
 * @module H_L/modules/map
 * @requires H_L
 *
 * Highmaps as a plugin for H_U or H_U Stock.
 *
